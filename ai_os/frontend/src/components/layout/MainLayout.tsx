...
export function MainLayout() {
    ...
    // Wrapped onFileSelect handler in useCallback to keep its reference stable across renders.
    // Impact: Combined with React.memo() in sibling components (AgentSidebar, FileExplorer, ChatPanel),
    // this prevents severe layout thrashing and unnecessary reconciliation when the user types in the CodeEditor.
