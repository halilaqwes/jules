...
export function MainLayout() {
    ...
    // ⚡ Bolt Optimization: Memoize the callback to prevent FileExplorer from re-rendering
    // on every keystroke in the CodeEditor (which updates the `code` state in MainLayout).
