...
export function MainLayout() {
    ...
    // ⚡ Bolt Optimization: Memoize the event handlers so that heavy sibling components
    // wrapped in React.memo do not receive new function references on every render.
    // This prevents layout thrashing during high-frequency updates like editor keystrokes.
