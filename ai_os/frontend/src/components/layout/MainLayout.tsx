...
export function MainLayout() {
    ...
    // ⚡ Bolt: Memoize heavy sibling components to prevent layout thrashing and
    // unnecessary reconciliation on every keystroke in CodeEditor
    const memoizedAgentSidebar = useMemo(() => <AgentSidebar />, []);
