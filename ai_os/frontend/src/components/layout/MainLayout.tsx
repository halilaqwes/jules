...
// Memoize heavy sibling components to prevent re-renders when CodeEditor state changes
const MemoizedAgentSidebar = memo(AgentSidebar);
...
export function MainLayout() {
    ...
    // Wrap callbacks in useCallback to maintain referential equality across re-renders
    ...
    return (
        <div className="flex h-screen w-screen bg-black overflow-hidden font-sans">
            ...
            <MemoizedChatPanel selectedModel={selectedModel} />
        </div>
    );
}
