...
// Wrapped FileExplorer in React.memo() to prevent unnecessary re-renders when parent state (like CodeEditor keystrokes in MainLayout) changes.
// Impact: Eliminates expensive UI re-renders for the file explorer component during typing.
