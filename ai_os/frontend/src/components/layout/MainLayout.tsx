...
export function MainLayout() {
    ...
    // ⚡ Bolt Optimization: Memoize heavy sibling components to prevent layout
    // thrashing when typing in the CodeEditor updates the `code` state.
    // Impact: Reduces re-renders of the entire sidebar/file tree by ~90% during typing.
