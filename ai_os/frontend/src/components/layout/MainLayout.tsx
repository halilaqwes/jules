...
export function MainLayout() {
    ...
    // Memoize event handlers to prevent recreating them on every keystroke
    ...
    // Memoize heavy sibling components to prevent re-rendering when `code` changes on every keystroke
