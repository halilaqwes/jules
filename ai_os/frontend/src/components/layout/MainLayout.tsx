...
export function MainLayout() {
    ...
    // Memoize handlers to prevent heavy sibling components (FileExplorer, CodeEditor)
    // from re-rendering on every keystroke when MainLayout state updates.
    // Expected impact: Drastically reduces layout thrashing and CPU usage during typing.
