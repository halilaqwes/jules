...
export function MainLayout() {
    ...
    // ⚡ Bolt: Memoize the file select handler to maintain reference stability.
    // This prevents the FileExplorer component from unnecessarily re-rendering
    // when the CodeEditor updates the `code` state on every keystroke.
