...
export function MainLayout() {
    ...
    // ⚡ Bolt: Memoize callbacks to prevent breaking child component memoization
    ...
    // ⚡ Bolt: Memoize heavy sibling components to prevent unnecessary re-renders on every keystroke in CodeEditor
