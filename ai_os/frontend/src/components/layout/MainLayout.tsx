...
export function MainLayout() {
    ...
    // ⚡ Bolt: Wrapped onFileSelect handler in useCallback to maintain referential equality.
    // This ensures React.memo on FileExplorer properly prevents re-renders when MainLayout state updates.
