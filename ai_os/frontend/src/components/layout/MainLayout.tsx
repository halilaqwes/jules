...
export function MainLayout() {
    ...
    // ⚡ Bolt Optimization: Use useCallback to memoize callback functions.
    // This prevents breaking memoization on child components like FileExplorer and CodeEditor
    // during frequent state updates (e.g., typing in the editor).
