...
export function MainLayout() {
    ...
    // What: Wrapped inline callbacks (onFileSelect, onChange) with useCallback and components with React.memo
    // Why: State is lifted up to MainLayout. Keystrokes in CodeEditor update 'code' state, causing MainLayout to re-render. This prevents siblings like AgentSidebar, FileExplorer, and ChatPanel from re-rendering on every keystroke.
    // Impact: Massively reduces layout thrashing and React reconciliation overhead during typing.
